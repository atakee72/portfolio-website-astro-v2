...
export const contactSheet: Frame[] = [
  ...
  { k: 'code', text: '$ pnpm build\n  ✓ 22 pages\n  ✓ 0 warnings', tag: 'BUILD OK' },
  {
    ...
    note: 'A museum of my early web, 1999–2013: three sites dug out of the Wayback Machine, two blogs rescued alive, one page found in the rubble — restored as they were and browsable again, curator plaques and 1999-style guestbook included.',
